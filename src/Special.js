...
//     e.stopPropagation();
//     setShowLetterPassword(true);
//   };

//   // Handle letter password submission
//   const handleLetterPasswordSubmit = (e) => {
//     e.preventDefault();
//     if (letterPasswordInput === letterPassword) {
//       setShowLetterPassword(false);
//       setIsModalOpen(true);
//       setLetterPasswordInput(''); // Reset password input
//     } else {
...
//   // Handle initial password submission
...
//           {/* Letter Password Modal */}
//           {showLetterPassword && (
//             <div className="modal-overlay" onClick={() => setShowLetterPassword(false)}>
//               <div className="password-form" onClick={(e) => e.stopPropagation()}>
//                 <form onSubmit={handleLetterPasswordSubmit}>
//                   <label htmlFor="letterPassword">Enter the magic words 💌</label>
//                   <input
//                     type="password"
//                     id="letterPassword"
//                     value={letterPasswordInput}
//                     onChange={(e) => setLetterPasswordInput(e.target.value)}
//                     autoFocus
//                   />
